...
pub const DEFAULT_PACKET_THREAD_QUEUE_SIZE: u32 = 8;
pub const DEFAULT_FRAME_THREAD_QUEUE_SIZE: u32 = 8;
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of Timestamp"][::std::mem::size_of::<Timestamp>() - 16usize];
...
pub const SchedulerNodeType_SCH_NODE_TYPE_NONE: SchedulerNodeType = 0;
pub const SchedulerNodeType_SCH_NODE_TYPE_DEMUX: SchedulerNodeType = 1;
pub const SchedulerNodeType_SCH_NODE_TYPE_MUX: SchedulerNodeType = 2;
pub const SchedulerNodeType_SCH_NODE_TYPE_DEC: SchedulerNodeType = 3;
pub const SchedulerNodeType_SCH_NODE_TYPE_ENC: SchedulerNodeType = 4;
pub const SchedulerNodeType_SCH_NODE_TYPE_FILTER_IN: SchedulerNodeType = 5;
pub const SchedulerNodeType_SCH_NODE_TYPE_FILTER_OUT: SchedulerNodeType = 6;
pub type SchedulerNodeType = ::std::os::raw::c_uint;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct SchedulerNode {
    pub type_: SchedulerNodeType,
    pub idx: ::std::os::raw::c_uint,
    pub idx_stream: ::std::os::raw::c_uint,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of SchedulerNode"][::std::mem::size_of::<SchedulerNode>() - 12usize];
    ["Alignment of SchedulerNode"][::std::mem::align_of::<SchedulerNode>() - 4usize];
    ["Offset of field: SchedulerNode::type_"]
        [::std::mem::offset_of!(SchedulerNode, type_) - 0usize];
    ["Offset of field: SchedulerNode::idx"][::std::mem::offset_of!(SchedulerNode, idx) - 4usize];
    ["Offset of field: SchedulerNode::idx_stream"]
        [::std::mem::offset_of!(SchedulerNode, idx_stream) - 8usize];
};
pub type SchThreadFunc = ::std::option::Option<
    unsafe extern "C" fn(arg: *mut ::std::os::raw::c_void) -> ::std::os::raw::c_int,
>;
unsafe extern "C" {
    pub fn sch_alloc() -> *mut Scheduler;
}
unsafe extern "C" {
    pub fn sch_free(sch: *mut *mut Scheduler);
}
unsafe extern "C" {
    pub fn sch_start(sch: *mut Scheduler) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    pub fn sch_stop(sch: *mut Scheduler, finish_ts: *mut i64) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    #[doc = " Wait until transcoding terminates or the specified timeout elapses.\n\n @param timeout_us Amount of time in microseconds after which this function\n                   will timeout.\n @param transcode_ts Current transcode timestamp in AV_TIME_BASE_Q, for\n                     informational purposes only.\n\n @retval 0 waiting timed out, transcoding is not finished\n @retval 1 transcoding is finished"]
    pub fn sch_wait(
        sch: *mut Scheduler,
        timeout_us: u64,
        transcode_ts: *mut i64,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    #[doc = " Add a demuxer to the scheduler.\n\n @param func Function executed as the demuxer task.\n @param ctx Demuxer state; will be passed to func and used for logging.\n\n @retval \">=0\" Index of the newly-created demuxer.\n @retval \"<0\"  Error code."]
    pub fn sch_add_demux(
        sch: *mut Scheduler,
        func: SchThreadFunc,
...
unsafe extern "C" {
    #[doc = " Signal to the scheduler that the specified muxed stream is initialized and\n ready. Muxing is started once all the streams are ready."]
    pub fn sch_mux_stream_ready(
        sch: *mut Scheduler,
        mux_idx: ::std::os::raw::c_uint,
        stream_idx: ::std::os::raw::c_uint,
    ) -> ::std::os::raw::c_int;
...
unsafe extern "C" {
    pub fn sch_sq_add_enc(
        sch: *mut Scheduler,
        sq_idx: ::std::os::raw::c_uint,
        enc_idx: ::std::os::raw::c_uint,
        limiting: ::std::os::raw::c_int,
        max_frames: u64,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    #[doc = " Called by muxer tasks to signal that a stream will no longer accept input.\n\n @param stream_idx Stream index previously returned from sch_add_mux_stream()."]
    pub fn sch_mux_receive_finish(
        sch: *mut Scheduler,
        mux_idx: ::std::os::raw::c_uint,
        stream_idx: ::std::os::raw::c_uint,
    );
...
unsafe extern "C" {
    pub fn sch_mux_sub_heartbeat_add(
        sch: *mut Scheduler,
        mux_idx: ::std::os::raw::c_uint,
        stream_idx: ::std::os::raw::c_uint,
        dec_idx: ::std::os::raw::c_uint,
